...
class ChooseAppointmentDateTime extends StatefulWidget {
  final Function(String) onDateSelection;
...
class _ChooseAppointmentDateTimeState extends State<ChooseAppointmentDateTime> {
  String selecteDate = "", selectedTime = "";
        ...
        MyTextField(
          ...
          suffixIcon: InkWell(
            onTap: () async {
              ...
              widget.onDateSelection(date.toString());
            },
            child: const Icon(
              Icons.edit_square,
        ...
        SizedBox(
          ...
          child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return selectDate(
                    text: timings,
                    isSelected: selectedTime == timings,
