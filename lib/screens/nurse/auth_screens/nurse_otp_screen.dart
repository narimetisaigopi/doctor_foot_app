...
class NurseOtpScreen extends StatefulWidget {
  const NurseOtpScreen({super.key});

  @override
  State<NurseOtpScreen> createState() => _NurseOtpScreenState();
}

class _NurseOtpScreenState extends State<NurseOtpScreen> {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          "${Strings.otpString} ${nurseAuthController.mobileNumberController.text}",
                    ...
                    Pinput(
                      onChanged: (value) {
                        otp = value;
                        if (otp.length == 6) {
                          nurseAuthController.verifyOTP(otp);
                        }
                      },
