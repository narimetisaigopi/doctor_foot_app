...
class FootAppointmentWidget extends StatefulWidget {
  ...
  const FootAppointmentWidget(
      {super.key, required this.footServiceAppointmentModel, this.title = ""});
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                widget.footServiceAppointmentModel.addressModel!
                                    .getAddress(),
                                maxLines: 1,
                          ...
                          Text(
                            Utility().formatDate(widget
                                .footServiceAppointmentModel.timestamp!
                                .toDate()),
                            style: const TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.w500,
              ...
              onRateServicePressed: () {
                Utility.myBottomSheet(context,
                    widget: AddReviewRatingsScreen(
                      docId: widget
                          .footServiceAppointmentModel.footServiceModel!.docId,
